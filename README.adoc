...
|typeCode
|code indicating the type of _Aircraft_

|registration
|international code identifying the _Aircraft_
|===
...
|name
|the commercial name of the _Airline_

|foundationDate
|the date on which its activity began
|===
...
|name
|the international name of the _Airport_

|iataCode
|the _Airport_ code for the International Air Transport Association

|icaoCode
|the _Airport_ code for the International Civil Aviation Organization
|===
